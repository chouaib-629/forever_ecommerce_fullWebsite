        ...
        <div>
            ...
            <div className="my-10 flex flex-col md:flex-row gap-16">
                ...
                <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
                    <p>
                        Forever was born out of a passion fro innovation and a
                        desire to revolutionize the way people shop online. Our
                        journey began with a simple idea: tp provide a platform
                    ...
                    <p>
                        ...
                        every taste and prefrence. From fashion and beauty to
                        electronics and home essentials, we offer a extensive
                        collection sourced from trusted brands and suppliers.
                    </p>
                    <b className="text-gray-800">Our Mission</b>
                    <p>
                        Our mission at Forever is to empower customers with
                        choice, convinience, and confiance. We're dedicated to
            ...
            <div className="flex flex-col md:flex-row text-sm mb-20">
                ...
                <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
                    ...
                    <p className=" text-gray-600">
                        ...
                        you the way, ensuring your satisfation is our top
                        priority.
                    </p>
                </div>
            </div>
